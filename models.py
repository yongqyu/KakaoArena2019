...
class RNN(nn.Module):
    def __init__(self, num_readers, num_writers, num_keywd, num_items, num_magazine, latent_dim):
        ...
        self.items_fc = nn.Linear(4*self.latent_dim, 3*self.latent_dim)
    ...
    def forward(self, data):
        ...
        merged_item_embedding = self.items_fc(torch.cat([item_embedding, writer_embedding, keywd_embedding, magazine_embedding], 2))
